...
@interface FCHupoViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, JNBannerViewDelegate, JNBannerViewDataSource, UISearchBarDelegate>
...
@implementation FCHupoViewController
