...
@interface FCQitaViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, JNBannerViewDelegate, JNBannerViewDataSource, UISearchBarDelegate>
...
@implementation FCQitaViewController
