...
@interface FCMingjiaViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, JNBannerViewDelegate, JNBannerViewDataSource, UISearchBarDelegate>
...
@implementation FCMingjiaViewController
